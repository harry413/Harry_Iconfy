              ...
              <div className="relative rounded-lg bg-gray-800 p-8 shadow-lg dark:bg-dark-2 sm:p-12">
                <form>
                  ...
                  <div>
                    <button
                      type="submit"
                      className="w-full rounded border border-black bg-black p-3 text-white transition hover:bg-opacity-90"
                    >
                      Send Message
                    </button>
                  </div>
    ...
    <>
      <div className="mb-6">
        <input
          ...
          placeholder={placeholder}
          name={name}
          className="w-full rounded border border-stroke px-[14px] py-3 text-base text-black outline-none focus:border-primary border-dark-3 bg-slate-300 dark:text-dark-6"
        />
      </div>
    </>
  );
